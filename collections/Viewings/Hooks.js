...
Viewings.before.insert(function (userId, doc) {
  ...
  doc.averageSlideHullSize = Meteor.call('viewings.getAverageSlideHullSize', { viewing: doc });
  doc.averageStepHullSize = Meteor.call('viewings.getAverageStepHullSize', { viewing: doc });
