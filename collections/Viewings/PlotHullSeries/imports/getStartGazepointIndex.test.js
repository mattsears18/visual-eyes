...
describe('PlotHullSeries.getStartGazepointIndex()', () => {
  ...
  it('gets the start indices (continuous)', async () => {
    ...
    chai.expect(hullSeries.getStartGazepointIndex(9)).to.equal(0);
    chai.expect(hullSeries.getStartGazepointIndex(8)).to.equal(0);
    chai.expect(hullSeries.getStartGazepointIndex(7)).to.equal(0);
    chai.expect(hullSeries.getStartGazepointIndex(6)).to.equal(0);
    chai.expect(hullSeries.getStartGazepointIndex(1)).to.equal(0);
  });
