export default function saveAverageHullCoverage({
  slideStep,
}) {
...
//
// Meteor.methods({
//   'viewings.saveAverageHullCoverage'({ jobId, callback }) {
//     if(Meteor.isServer) {
//       check(jobId, String);
//
...
//       }
//
//       console.log('viewings.saveAverageHullCoverage ' + job.data.viewingId);
//
