...
describe('ViewingHullSeries.getCentroidTrace()', () => {
  it('has no hull', () => {
    ...
    chai.expect(() => { hullseries.getCentroidTrace() }).to.throw('noHull')
  })
  ...
  it('gets the initial centroid trace', () => {
    ...
    let hull = hullseries.getHulls()[0]
    let trace = hullseries.getCentroidTrace({ initial: true, hull: hull })
  ...
  it('gets a centroid trace (not initial)', () => {
    ...
    let hull = hullseries.getHulls()[3]
    let trace = hullseries.getCentroidTrace({ initial: false, hull: hull })
