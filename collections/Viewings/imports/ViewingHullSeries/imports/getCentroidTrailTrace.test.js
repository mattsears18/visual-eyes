...
describe('ViewingHullSeries.getCentroidTrailTrace()', () => {
  ...
  it('gets a centroid trail trace (not initial) for the first 5 hulls', () => {
    ...
    let trace = hullseries.getCentroidTrailTrace({ initial: false, endHullIndex: 4 })
  ...
  it('gets the centroid trail trace (not initial) for the first hull', () => {
    ...
    let trace = hullseries.getCentroidTrailTrace({ initial: false, endHullIndex: 0 })
  ...
  it('gets the centroid trail trace for a specified hull', () => {
    let points = [
      { x: 100, y: 400, timestamp: 0 },
      { x: 200, y: 300, timestamp: 1000 },
      { x: 300, y: 200, timestamp: 2000 },
    ...
    let hull = hullseries.getHulls()[4]
    let trace = hullseries.getCentroidTrailTrace({ initial: false, lastHull: hull })
