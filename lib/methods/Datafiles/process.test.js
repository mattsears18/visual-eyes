...
import shortSMITestData from '../../../testFiles/shortFile/shortSMITestData';
import mediumSMITestData from '../../../testFiles/mediumFile/mediumSMITestData';
...
describe('Datafiles', function() {
  describe('.process() METEOR METHOD', function() {
    ...
    describe('Pre-process', function() {
      dataRenamed = renameHeaders(shortSMITestData);
      ...
      dataFixations = fixationsOnly(dataRenamed);
